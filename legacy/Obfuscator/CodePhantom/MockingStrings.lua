...
-- just add more, don't remove them, thanks.
...
local mockingStrings = {
  ...
  "skidding is cute, I love skidding, can I skid you? .w.",
  "this obfuscator has the power of gods, and it shall not be deobfuscated",
  "alright b, i'm going to forget about you, and you're going to forget about me, and we're going to pretend like this never happened, capiche?",
  "you couldn't stop the Lua/C++ gods from engineering this obfuscator. rawr x3",
  "This obfuscator is so unskiddable, that it's not even funny anymore, quit trying to deobfuscate it, you're wasting your time",
  "hold on, let us pray to the Lua/C++ gods for a second, oh mighty Lua/C++ gods, please bless this obfuscator with your power, rawr owo x3",
  "C++/Lua gods do infact exist, and they are the ones who made this obfuscator, I'm literally shaking and crying rn, amennn uwu >:3",
  "Can't wait to get my hands on some of that sweet, sweet, coffee milk",
  "hold on, let me inject more coffee milk into my veins, oh yeah, that's the stuff. Let's get coding again",
  "frfr no cap sir. kinda sus doe ngl :flushed: :blush:",
  "brainwashed, but in a good way. uwu >:3",
  "nooooo, you can't Ctrl+F for 'while true do'. You're NOT supposed to see the virtual machine that is easy to dump!!!!",)",
  "tostring",
  "haha",
  "cute.",
  "->",
